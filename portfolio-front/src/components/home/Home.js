                    ...
                    {users.map((item, index) => (
                        ...
                        >
                            <div
                                ...
                                <button
                                    className="text-white text-md font-medium whitespace-nowrap bg-violet-500 self-stretch justify-center items-center mt-10 px-16 py-2 rounded-3xl border-2 border-solid border-violet-500 max-md:px-5">
                                    See complete bio
                                </button>
                            </div>
                        </div>
